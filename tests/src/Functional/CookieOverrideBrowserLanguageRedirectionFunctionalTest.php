...
class CookieOverrideBrowserLanguageRedirectionFunctionalTest extends FunctionalTestBase {
   ...
   * language cookie, then the end-client should be redirected to the cookie preferred lang.
   *
  ...
  /**
   * Provides test data for the testCookieMustRedirectOverBrowserPreferredRedirection() method.
   */
